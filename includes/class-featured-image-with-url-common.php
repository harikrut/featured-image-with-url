...
class Featured_Image_With_URL_Common {
	 ...
	 * @return value
	 */
	function harikrutfiwu_woocommerce_36_support( $value, $product){
		global $harikrutfiwu;
	 ...
	 * @return void
	 */
	function harikrutfiwu_set_thumbnail_id_true(){
		global $harikrutfiwu;
	 ...
	 * @return mixed
	 */
	function harikrutfiwu_set_thumbnail_true( $value, $object_id, $meta_key, $single ){
	 ...
	 * @return string
	 */
	function harikrutfiwu_overwrite_thumbnail_with_url( $html, $post_id, $post_image_id, $size, $attr ){
	 ...
	 */
	function harikrutfiwu_get_image_sizes() {
		global $_wp_additional_image_sizes;
		$sizes = array();
	 ...
	 * @return void
	 */
	function harikrutfiwu_get_wcgallary_meta( $post_id ){
	 ...
	 */
	function harikrutfiwu_set_customized_gallary_ids( $value, $product ){
	 ...
	 */
	function harikrutfiwu_replace_attachment_image_src( $image, $attachment_id, $size, $icon ) {
		global $harikrutfiwu;
	 ...
	 */
	function harikrutfiwu_get_image_size( $size ) {
	 ...
	 * @return bool
	 */
	function harikrutfiwu_is_disallow_posttype( $posttype ) {
	 ...
	 * @return array $markup
	 */
	function harikrutfiwu_woo_structured_data_product_support( $markup, $product ) {
	 ...
	 */
	function harikrutfiwu_shopzio_product_image_url( $image, $attachment_id ) {
	...
	function harikrutfiwu_woocommerce_available_variation( $value, $variable_product, $variation ){
